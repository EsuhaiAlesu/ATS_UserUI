...
| 🛠️ [22 — Build khung điều hướng (IA Phase 1)](22-build-khung-dieu-huong-phase-1.md) | **(A) Spec để code**: `OperatorLayout` (1 rail) · file đụng tới · phác API · thứ tự làm có kiểm · rủi ro/rollback · DoD |
| 📈 [23 — Đọc số Bước 0 & cây quyết định](23-phan-tich-buoc-0-quyet-dinh.md) | **(B) Số về thì làm gì**: bảng ngưỡng xanh/vàng/đỏ · cây quyết định (trễ→stage nào→nâng/đổi model) · ý nghĩa GO/NO-GO · cập nhật 21/00 |
| 🤝 [24 — Phân vai & phối hợp đội](24-phan-vai-lo-trinh-phoi-hop.md) | **(C) Chống dẫm nhau**: RACI · chuỗi phụ thuộc (Bước 0 chặn gì · FE-BE song song) · governance 1-người-push · việc kế tiếp mỗi vai |
